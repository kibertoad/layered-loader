...
export interface DataSource<LoadedValue, LoadParams = string, LoadManyParams = LoadParams> {
...
export interface GroupDataSource<LoadedValue, LoadParams = string, LoadManyParams = LoadParams> {
