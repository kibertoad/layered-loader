...
export class GeneratedDataSource<LoadedValue, LoadParams = undefined, LoadManyParams = LoadParams> implements DataSource<LoadedValue, LoadParams, LoadManyParams> {
